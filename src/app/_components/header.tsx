  ...
  return (
    <header className="flex flex-col md:flex-row items-center justify-between py-8 mb-6">
      ...
      <nav className="flex flex-wrap justify-center gap-4 md:gap-6 mt-4 md:mt-0">
        <Link href="/about" className="text-sm font-medium hover:text-accent transition-colors font-merriweather">
          About us
        </Link>
        <Link href="/team" className="text-sm font-medium hover:text-accent transition-colors font-merriweather">
          Team
        </Link>
        <Link href="/community" className="text-sm font-medium hover:text-accent transition-colors font-merriweather">
          Community
        </Link>
