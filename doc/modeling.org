...
If all the conditions are met before a certain date, the following mutual obligations will arise (choose one)
- on that date; or
- as soon as all the conditions are met; or
- when parties give notice that the conditions are met
