...
a comprehensive ontology of the state space of the company and the state transition operations that can occur.

we use an object-oriented paradigm to model the company. they suffer CRUD operations.

See also https://arxiv.org/abs/cs/0702089
...
Also consider the difference between endurants and perdurants, discussed in /Engineering Legal Ontologies/.

** Objects

*** Dates and Times
**** no need to reinvent the wheel here
**** need support for business dates, holidays, etc, calendrical calculations.
*** Utility Objects
...
*** State Transition / Relation Transition Methods
**** Create
***** NaturalPerson
****** phrase: "birth"
****** evidence
...
They also have a company secretary and an auditor.

In addition to shareholders, there may be other investors who have executed investment agreements with the company, in the form of notes, bonds, SAFEs, warrants, etc.

Other metadata about the corporation includes dates of AGMs and government filings.

The corporation may have sent or received notices to third parties.

The corporation may have made filings to the state.

The corporation may have officially given authorization to third parties to represent it in certain ways; for example, at another corporation's AGM.
...
A trust is a case of Organization.
...
Of some other security not defined above, e.g. SAFE.
...
***** ordinary
***** special
**** the /majority requirement/ for resolution:
***** ordinary is usually 50%
***** special is usually 75%
***** but the constitution may specify a different number for the subject matter
