...
"Pretty much every time you want to alter the state of the company, any kind of [CRUD](https://en.wikipedia.org/wiki/Create,_read,_update_and_delete) operation requires uploading a PDF to the government website."
