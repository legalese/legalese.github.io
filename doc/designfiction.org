...
"So, imagine, what Classpass does for gyms, somebody should do for toilets. In fact, go one step further to the WeWork model, and operate a federated network of toilets, open to anyone in the network. Where the physical establishment -- let's call it the host -- where the host is concerned, it exposes a managed-services vendor API. It's a bit like what the New Black do for coffee bars inside big corporate offices. Have you heard about that model?"
...
"It's one of my portfolio companies. We went in for their Series C. But a lot of the companies that I funded were using it already even before that. All the stuff that you do with crypto-corporations, Legalese does with regular corporations."
...
"Most founders aren't technical enough. At this level of risk, there are some corporate secretarie who would do the work on spec. They'll take 20% of the company, up front, in return for setting it up. An incubator would take 10%, and maybe give you $100,000 of seed capital in return."
...
"Pretty much every time you want to alter the state of the company, any kind of CRUD operation requires uploading a PDF to the government website."
