...
** Orgs and Projects with related interests

Mostly in the blockchain / smart contracts space.

- The [[http://www.estrellaproject.org/][Estrella Project]] ran from 2006 to 2008 and produced [[https://github.com/RinkeHoekstra/lkif-core][LKIF]], a legal ontology.
- Primavera's http://coalalex.org/ is interested in relating blockchain smart contracts to the incumbent legal system.
- https://www.hyperledger.org/ comes off the Linux Foundation.
- http://www.r3.com/ has raised a lot of money. They work with banks, because that's where the money is.
