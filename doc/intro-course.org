...
** input from Dustin:
-Alexis’s video presentation
-Meng’s video presentation
-Precision’s Counterfeit
-Why Contracts are Written in Legalese (which I’m currently reading. reading things by lawyers is such a pleasure in comparison to computer scientists.)
-Meng’s book chapter
-Wolfram’s article? 
-Somthing by Nick Szabo
-Innovator’s Solution (somebody send me an epub)
-Mapping Technique
-Adams book
-For people with a STEM background, Cook’s notes on logic
-First x sections of my thesis
-Z3 tutorial, because I think it’s a good intro to SMT.
...
- Model Checking. CTL* and LCTL. [[http://smtlib.cs.uiowa.edu/language.shtml][SMTLIB2]]. Z3. TLA+. Alloy. IVy. Uppaal. NuSMV. [[https://yurichev.com/writings/SAT_SMT_draft-EN.pdf][SAT/SMT]].
