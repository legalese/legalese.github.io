...
*PLEASE REMEMBER THAT unless you have the compensation committee's written and public approval on this, no financial relationship is assumed.*
...
As a company, however, we don't have very many rules but we do have 3 commandments that operate jointly and concomitantly extend to _everything_:
  ...
  *1. Do not make or expect another person to do what he/she is unwilling to do.*
    ...
    *3. By default, all conversations must be held publicly - this means either in email copying active-team@legalese.io and/or on a public channel in Slack*
...
*internally*
**** TODO complete the 20p business plan
**** TODO refine / create moqup of what v2 should look like
**** TODO build pages to test monetisation models
**** TODO test monetisation models
**** DONE do back-of-the-envelope calculations to see if business will be viable based on what people are willing to pay
**** TODO start internal fortnight email digest going by end June
**** TODO start building up social media and web presence (twitter, angelist, etc)
