...
** 3B. Communication Channels
  - realtime chat :: Slack
  - email :: Google Groups -- collective@legalese.com is the primary address. You can [[https://groups.google.com/a/legalese.io/forum/#!forum/active-team][browse the archives]]. The default is that all communications are CC-ed to the team.
